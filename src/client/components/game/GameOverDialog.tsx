// ABOUT: Modal dialog displayed when a game ends — shows result, stats, and actions.
// ABOUT: Posts the anonymous games counter on first mount (StrictMode-safe via useRef guard).

import { useEffect, useRef } from 'react';
import type { Side, Difficulty, WinReason } from '@/shared/game/types';
import { Button } from '@/client/components/ui/button';
import { incrementAnonymousGamesCount } from '@/client/lib/api';
...
export function describeReason(reason: WinReason): { headline: string; detail: string } {
  switch (reason.kind) {
    case 'king-captured':
      return {
