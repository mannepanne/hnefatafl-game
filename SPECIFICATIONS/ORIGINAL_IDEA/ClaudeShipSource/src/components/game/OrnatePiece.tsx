...
// Exported so the capture animation can reuse the ornate look.
// Base sits at y=0 of this component. Pass `transparent` for fade
// animations; all materials honour the flag so `mat.opacity` can
// be animated from the outside.
